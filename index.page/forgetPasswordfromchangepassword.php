...
if(isset($_POST['submit']))
{
  ...
  if(mysqli_num_rows($teacherResult) > 0 || mysqli_num_rows($adminResult) > 0 || mysqli_num_rows($studentsResult) > 0)
  {
    ...
    <br>
    <p><a href="localhost/student-ms/index.page/changeforget.php?secret='.base64_encode($email).'"><button class="reset" style="color: black; background-color: #fb8b24; border-radius: 5px; padding: 10px; border: none;">Reset Password</button>
    </a></p>
    <br>
    ...
    <nav>
      ...
      <ul class="nav-list">
            ...
            if (isset($_SESSION['adminname'])) {
                // If the user is an admin, display admin-specific navigation
                echo '<li><a href="../admin-page/admin-home.php">Home page</a></li>';
                echo '<li><a id="space" href="../Admin/admin-profile.php">My profile</a></li>';
            } elseif (isset($_SESSION['studentname'])) {
                // If the user is a student, display student-specific navigation
                echo '<li><a href="../Student/student-profile.php">Home page</a></li>';
                echo '<li><a id="space" href="../Student/student-profile.php">My profile</a></li>';
            }elseif (isset($_SESSION['teachername'])) {
              // If the user is a student, display student-specific navigation
              echo '<li><a href="../admin-page/teacher-home.php">Home page</a></li>';
              echo '<li><a id="space" href="../Teachers/teacher-profile.php">My profile</a></li>';
          }
            ?>
